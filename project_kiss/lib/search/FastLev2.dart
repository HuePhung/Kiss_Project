...
class NonAsyncLev{
  ...
  static Future<List<Ingredient>> getIndividualItems(String startString) async{
  ...
  static List<Ingredient> testMethod(String string) {

    /*
    List<Ingredient> ingredients =  [searchForOneIngredient(string, 2)];//getIndividualItems(string);
    int p=0;
 ...
 */
    ...
    //return "This is  a prime"; //[Ingredient("This", "is", "a", "prime!")];
    //return ingredients;
    /*
